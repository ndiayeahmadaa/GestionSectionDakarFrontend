...
import { ModifierMembreComponent } from './modifier-membre/modifier-membre.component';
...
@NgModule({
  declarations: [ListeMembreComponent, AjoutMembreComponent, ModifierMembreComponent],
  imports: [
    MembreRoutingModule,
    CommonModule,
